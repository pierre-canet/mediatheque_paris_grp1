...
<section class="search-filters">
    ...
    <form method="GET" action="<?php echo url('catalog/games'); ?>">
        ...
        <div class="search-bar">
            <!-- Champ de saisie pour la recherche du titre du jeu vidéo -->
        ...
        <div class="filters">
            ...
            <div class="filter-group">
                ...
                <!-- Menu déroulant pour sélectionner le genre du jeu vidéo -->
                <select id="genre" name="genre" class="filter-select">
                    ...
                    <!-- Options de genres spécifiques pour les jeux vidéo -->
