...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Films'); ?></title>
    ...
    <section class="container">
        ...
        <section class="search-filters">
            ...
            <form method="GET" action="<?php echo url('catalog/movies'); ?>">
                ...
                <div class="search-bar">
                    ...
                    <input type="text" name="search_term" placeholder="Rechercher un film..." class="search-input" value="<?php echo htmlspecialchars($search_term ?? ''); ?>">
                    ...
                    <?php if (!empty($search_term) || ($search_genre ?? 'all') != 'all' || ($search_availability ?? 'all') != 'all'): ?>
                        ...
                        <a href="<?php echo url('catalog/movies'); ?>" class="btn btn-secondary" style="margin-left: 10px;">Effacer</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="filters">
                    ...
                    <div class="filter-group">
                        ...
                        <select id="genre" name="genre" class="filter-select">
                            ...
                            <!-- Options spécifiques de genre pour les films -->
            ...
            <?php else: ?>
                <?php foreach ($items as $item): ?>
                    <div class="item">
                        ...
                        <p>Réalisateur : <?php echo htmlspecialchars($item['writer_producer_editor']); ?></p>
                        <p>Note : <?php echo htmlspecialchars($item['ISBN13_classification_platform']); ?></p>
                        <p>Durée : <?php echo htmlspecialchars($item['page_number_duration_min_age']); ?> min</p>
        ...
        <div class="pagination">
            ...
            <?php if ($current_page > 1): ?>
                <a href="<?php echo url('catalog/movies?page=' . ($current_page - 1)); ?>" class="btn btn-prev-page">Page précédente</a>
            <?php endif; ?>

            <!-- Liens numériques des pages -->
            <div class="page-numbers">
                <!-- Toujours afficher la page 1 -->
                <a href="<?php echo url('catalog/movies?page=1'); ?>" class="page-number <?php echo $current_page == 1 ? 'active' : ''; ?>">1</a>
                ...
                for ($i = $start_page; $i <= $end_page; $i++): ?>
                    <a href="<?php echo url('catalog/movies?page=' . $i); ?>" class="page-number <?php echo $i == $current_page ? 'active' : ''; ?>">
                        <?php echo $i; ?>
                    </a>
                <?php endfor; ?>
            ...
            <?php if ($current_page < $total_pages): ?>
                <a href="<?php echo url('catalog/movies?page=' . ($current_page + 1)); ?>" class="btn btn-next-page">Page suivante</a>
            <?php endif; ?>
        </div>
            ...
            <div class="modal" id="item-<?php echo $item['id']; ?>">
                <div class="modal-content">
                    <div class="detail">
                        ...
                        <p>Réalisateur : <?php echo htmlspecialchars($item['writer_producer_editor'] ?? 'N/A'); ?></p>
